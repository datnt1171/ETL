...
df_factory = pd.read_excel(r"D:\VL1251\data\dim_factory.xlsx")
df_factory[df_factory.duplicated(subset='factory_code',keep=False)]
insert_data(df_factory, "dim_factory", conn)
...
df_product = pd.read_csv(r"D:\VL1251\data\dim_product.csv")

insert_data(df_product, "dim_product", conn)
