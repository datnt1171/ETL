...
cur = conn.cursor()
###################################################################################
df_copr13 = pd.read_excel(r"order_daily\COPR1320241119000332202411190001.xlsx")
...
df_copr23 = pd.read_excel(r"D:\temp_data\COPR1320241119000138202411190001.xlsx")
...
insert_query = """
    ...
    product_code, product_name, qc, factory_code, factory_name,
       ...
       gift_quantity, unit, small_unit, package_sales_quantity,
       package_gift_quantity, package_unit, priced_quantity,
       priced_unit, currency, exchange_rate, price, unpaid_tw,
       tax_tw, unpaid_vn, tax_vn, capital, gross_profit,
       gross_profit_rate, lot_code, tax_type, department, salesman,
       export_factory_code, export_factory, warehouse_code,
       warehouse_type, warehouse_loc, import_code, note,
       import_timestamp
    ) VALUES (
        %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, 
        %s, %s, %s, %s, %s, %s, %s, %s, %s, %s,
...
###########################################################################
# TEMP
df_copr23 = pd.read_excel(r"D:\VL1251\data\sales_2024.xlsx")
